...
## RESULT:
Thus a website is designed to train the house price model and to predict the price and is hosted in the URLs http://harshini.student.saveetha.in:8000/HouseModelTraining/ and http://harshini.student.saveetha.in:8000/HouseModelPrediction/ respectively. HTML code is validated.